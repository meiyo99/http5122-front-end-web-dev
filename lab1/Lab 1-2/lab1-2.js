...
var subTotal = item1 + item2 + item3; //TOTAL OF BILL BEFORE DISCOUNT AND TAX
var discountValu = 5; //FIVE BUCKS OFF COUPON
var subAfterDiscount = subTotal - 5;  //TOTAL AFTER COUPON AND BEFORE TAX
var taxHST = 1.13;  //HST
var totalAfterTax = subAfterDiscount * taxHST; //TOTAL AFTER TAX
var numOfDiners = 2;//NUMBER OF PEOPLE AT A TABLE
var eachPays = totalAfterTax / 2; //TOTAL FOR EACH CUSTOMER (TWO CUSTOMERS)
var billMessage = "You each owe $" + eachPays.toFixed(2);  //OUTPUT MESSAGE FOR ALERT BOX
